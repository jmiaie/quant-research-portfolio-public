...
- Corrected results and limitations live in the publication pack (`publication/options-risk-study/`).
...
Historical risk evaluation — implemented research lab with an accepted historical study and its publication pack on `main`. The option portfolio is hypothetical; no options-tape P&L and no live-deployment implication. Dashboard deferred.
